...
import { createTimelog, deleteTimelog, checkFunction, updateTimelog, changeColor, editTargetValue } from "../controller/timeLogController.js";
...
router
.route("/target-value").patch(editTargetValue)
